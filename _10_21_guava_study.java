...
//		ilist.add("vince");
	...
	public void testGuava8() {
		...
		map.put("finally_test", "51384");
		map.put("bin_test", "447584");
		String name = map.inverse().get("51384");
	...
	public void testGuava9() {
		...
		table.put("java", "jack", 80);
		table.put("php", "bin", 90);
		table.put("ui", "vince", 100);
		Set<Cell<String, String ,Integer>> cells = table.cellSet();//转换成set
		//可以存两个key
	}
